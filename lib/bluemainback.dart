...
class BluetoothAppone extends StatefulWidget {

  @override
  _BluetoothApponeState createState() => _BluetoothApponeState();
}

class _BluetoothApponeState extends State<BluetoothAppone> {
